...
const Banner = () => {
    return (
        ...
        <div className='text-white space-y-2 bg-black bg-opacity-10 p-6 rounded-lg'>
            <h1 className='text-3xl font-bold'>Welcome To My Site</h1>
            <p text-xl>There are four topics in my  quize website. <br/> Such as js,css,react js, git <br/>
